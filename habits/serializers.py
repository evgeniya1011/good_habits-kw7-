...
from habits.validators import RewardRelaterHabitValidator, TimeCompleteValidator, IsPleaseValidator, CheckValidator
...
class HabitSerializers(serializers.ModelSerializer):
    class Meta:
        model = Habit
        fields = '__all__'
        validators = [RewardRelaterHabitValidator(reward='reward', related_habit='related_habit'),
